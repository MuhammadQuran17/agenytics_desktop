...
return [
    ...
    */
    ...
    // Don't worry, we have used our own middleware to check if the user is an admin user
    // This parameter interfered with our Middleware logic. And yes guests, and users can not access the log viewer
    ...
    */
    ...
    'middleware' => [
        ...
        \App\Http\Middleware\FeedbackAdminMiddleware::class,
    ],
